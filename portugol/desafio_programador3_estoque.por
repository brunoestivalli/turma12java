programa
{
	...
	funcao inicio()
	{
		...
		se(pagamento == 1){
			...
			escreva("O preço do produto será R$ : "+mat.arredondar(z,2)+" com desconto de 20% devido a forma de pagamento.")
			
		}
		senao se(pagamento == 2){
			z = (z+((z/100)*9))
			z = (z-((z/100)*15))
			escreva("O preço do produto será R$ : "+mat.arredondar(z,2)+" com desconto de 15% devido a forma de pagamento.")
		}	
		senao se(pagamento == 3){
			z = (z+((z/100)*9))
			escreva("O preço do produto será R$ : "+mat.arredondar(z,2)+"R$ sem juros")
		}
		senao se(pagamento == 4){
			z = (z+((z/100)*9))
			z = (z+((z/100)*10))
			escreva("O preço do produto será R$ : "+mat.arredondar(z,2)+"R$ com juros de 10% devido a forma de pagamento.")		
